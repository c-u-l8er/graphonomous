...
One receipt per change made to WRL / TRVM / WEK / ComputeDriven under the repair protocol (brief §10): the exposing
Graphonomous case, the minimal reproducer, the owning layer, the change, the owning layer's test run, and the re-run of
the exposing case.
